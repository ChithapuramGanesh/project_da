...
![Likelihood of Skills Requested in the US Job Postings](images\top_skills_for_data_roles.png)
...
sns.set_theme(style='ticks')
sns.lineplot(data=df_trend_plot,legend=False,dashes=False,palette='tab10')
plt.title('Trending Top skills for Data Analytics in India')
plt.ylabel('likelihood of the job posting')
plt.xlabel('2023')
sns.despine()
...
for i in range(6):
    plt.text(11.2,df_trend_plot.iloc[-1,i],df_trend_plot.columns[i])

```

### Results

![Trending Top Skills for Data Analysts in the India](images\skills_trend_visual.png)  
...
![Salary Distributions of Data Jobs in the India](images\salary_distributions_visual.png)  
...
![The Highest Paid & Most In-Demand Skills for Data Analysts in the India](images\higesht_paid_and_demanded_jobs.png)
...
![Most Optimal Skills for Data Analysts in the India](images\optimal_skills_visual.png)    
*A scatter plot visualizing the most optimal skills (high paying & high demand) for data analysts in the US.*

#### Insights:

- The skill `looker` appears to have the highest median salary of nearly $97K, despite being less common in job postings. This suggests a high value placed on specialized database skills within the data analyst profession.
